...
import InputBoxes from '/src/components/InputBoxes.jsx'
  ...
  return (
    ...
    >
        <div className="w-full ">
            <div className="w-full max-w-md ml-auto mr-80 border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
                <form
